        ...
        <ul className='grid grid-cols-3  gap-x-3  '>
            {
              Productsreport.map((e)=>{
                return(
                    <li key={e.id} className='shadow-xl  drop-shadow-xl h-56 py-5 px-5 z-50 rounded-2xl '>
                        <Link className='relative flex flex-col justify-between   min-h-[170px]  '>
                            {/* left top */}
                            <div className='max-w-[326px] mb-8'>
                                <h3 className='text-2xl font-semibold text-head leading-7 mb-1.5'>{e.title}</h3>
                            ...
                            <div className='flex  items-center '>
                                ...
                                {/* img */}
                                <div className='absolute right-0 z-0 top-14'>
